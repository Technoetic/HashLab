...
step019 참고 레포 코드 분석 결과를 기반으로 기획 문서를 최종 보강한다.

**필요한 파일:**
- step025_planning_chunk*.md (기획 문서)
- step019_조사결과_chunk*.md (참고 레포 코드 분석 결과)

기획 문서를 읽고, step019 참고 레포 코드 분석 결과에서 반영할 내용을 식별하여 기획 문서를 최종 업데이트한다.
...
이 지침을 완료한 즉시 자동으로 step029.md를 읽고 수행한다. 사용자 확인을 기다리지 않는다.
