...
- **인라인 스크립트/스타일 삽입 금지** — 빌드 시 html-bundler.ps1이 자동 번들링

합리적인 선에서 최대한 많은 서브에이전트를 병렬로 사용하여 (동시 실행 최대 10개) 컴포넌트화를 수행한다.

**컴포넌트화 단계에서 절대로 superpowers:brainstorming을 사용하지 않는다.**
